          ...
          <div class="card-body register-img">
            <div class="row m-0">
              <div class="col-lg-6 d-none d-lg-block py-2 text-center">
                <img src="{{ asset('images/gallery/register.png') }}" alt="" class="img-fluid mt-3 pl-3" width="400"
                  height="230">
              </div>
              <div class="col-lg-6 col-md-12 px-4 pt-3 bg-white">
                ...
                <input type="text" class="form-control mb-3" placeholder="Firstname" />
                <input type="text" class="form-control mb-3" placeholder="Lastname" />
